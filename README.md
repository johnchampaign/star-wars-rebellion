...
Code is MIT (see [`LICENSE`](LICENSE)); the license file is kept verbatim so
tooling detects it, and the scope carve-out lives here: all game content (rules, card text,
